...
export function ScrollSprintSite() {
  ...
  return <div className="site-shell">
    ...
    <main id="main">
      ...
      <section id="start" className="start-section section-space"><div className="page-width start-grid"><div className="start-copy"><span className="eyebrow">06 / Your next good move</span><h2>Bring the product.<br/>We’ll bring<br/><em>the possibilities.</em></h2><p>Choose your package above to pay securely through Whop. Then prepare this short brief and share it with us so we can confirm the creative direction and delivery date.</p><div className="brief-promise"><CheckCheck size={22}/><span>One-time package payment.<br/><strong>Clear scope before production.</strong></span></div></div>
